...
const App = () => {
  return (
    <Printer>
      <SchemaForm components={{ DatePicker, Input }}>
        <FormMegaLayout labelAlign="top" grid full autoRow columns={3}>
          <Field
            name="listx1"
            x-mega-props={{ span: 2 }}
            title="组件1"
...
如果需要把非 VirtualField 放入布局组件内，可以通过 `FormSlot`
      ...
      <SchemaForm components={{ DatePicker, Input }}>
        ...
        >
          ...
          <Field
            ...
            x-component="DatePicker"
          />
          <Field name="组件4" title="字段4" x-component="DatePicker" />
          <Field name="组件5" title="字段5" x-component="DatePicker" />
          <FormSlot>
